# ✔️ Rushi Technologies — Create & Run First Workflow (Beginner Level — Only Linux Commands)
...
jobs:
  basic-demo:
    ...
    steps:
      - name: Say Hello
        run: echo "Hello from Rushi Technologies"
...
jobs:
  files:
    ...
    steps:
      - name: Create file
        run: echo "Rushi Technologies TEST FILE" > demo.txt
  ...
  strings:
    ...
    steps:
      - name: Convert to uppercase
        run: echo "Rushi Technologies" | tr 'a-z' 'A-Z'
